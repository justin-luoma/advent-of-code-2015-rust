// Credit: https://github.com/acdibble/aoc/blob/master/2015/rs/day22/src/main.rs
...
pub fn day22() -> std::io::Result<()> {
    let file_path = env::current_dir()?.join(Path::new("inputs/day22.txt"));
